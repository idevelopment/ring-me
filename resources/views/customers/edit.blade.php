                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <form action="{{ url('customers') }}" method="post" class="form-horizontal">
                              ...
                              @if(empty($customer_item['company']))
                              ...
                              @else
                                ...
                                @endif
                                  ...
                                  <div class="form-group form-sep">
                                      <label for="name"
                                             class="col-md-3 control-label"><i class="fa fa-envelope"></i></label>
                                      <div class="col-md-8">
                                  ...
                                  <div class="form-group form-sep">
                                      <label for="phone"
                                             class="col-md-3 control-label"><i class="fa fa-phone"></i></label>
                                      <div class="col-md-8">
                                          <p class="form-control-static"><a href="callto:{!! $customer_item['phone'] !!}" id="phone" data-type="text" data-pk="1" data-url="/update" data-title="Change phone">{!! $customer_item['phone'] !!}</a>
                                          </p>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      <label for="name"
                                             class="col-md-3 control-label"><i class="fa fa-mobile"></i></label>
                                      <div class="col-md-8">
                                          <p class="form-control-static"><a href="callto:{!! $customer_item['mobile'] !!}" id="mobile" data-type="text" data-pk="1" data-url="/update" data-title="Change mobile">{!! $customer_item['mobile'] !!}</a>
                                          </p>
                                      </div>
                                  </div>
                              @endforeach
